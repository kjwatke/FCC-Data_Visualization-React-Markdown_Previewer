...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = __webpack_require__(168);

	var _marked2 = _interopRequireDefault(_marked);

	var _Heading = __webpack_require__(169);
	...
	var showInitialMD = "one line snippet: `var block`\n\n" + "blockquote:\n\n" + "> Blockquote: 'Four Score and Seven Years Ago'" + "some headings: \n\n" + "# h1 heading\n\n" + "### h3 heading\n\n" + "#### h4 heading\n\n" + "heading using ======\n" + "======\n\n" + "*[Made by Kevin Watke](https://www.freecodecamp.com/kjwatke)*\n\n" + "code block: \n" + "```\n" + "var name = 'so and so'\n" + "if (name === 'so') {\n" + "\tconsole.log(true)\n" + "}" + "```";
	...
	var App = function (_React$Component) {
	    ...
	    function App() {
	        ...
	        _this.getMarkdownText = function (val) {
	            var rawMarkup = (0, _marked2.default)(val, { sanitize: true, gfm: true });
	        ...
	        _this.getMarkdownText = _this.getMarkdownText.bind(_this);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement("div", { className: "app-container" }, _react2.default.createElement(_Heading2.default, null), _react2.default.createElement("textarea", { placeholder: "place md here", type: "text", className: "md-input", onChange: this.update }), _react2.default.createElement("div", { className: "md-input-title" }, "MARKDOWN"), _react2.default.createElement("div", { className: "md-output-title" }, "PREVIEW"), _react2.default.createElement("div", { className: "md-output", dangerouslySetInnerHTML: this.getMarkdownText(this.state.txt) }), _react2.default.createElement(_Footer2.default, null));
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Heading = function Heading() {
	    var repo = 'FCC-Data_Visualization-React-Markdown_Previewer';
	    return _react2.default.createElement("nav", { className: "nav-main" }, _react2.default.createElement("h3", { className: "title" }, "Github Flavored Markdown Preview"), _react2.default.createElement("h4", null, _react2.default.createElement("a", { target: "_blank", href: 'https://www.github.com/kjwatke/' + repo }, "() => Github Repo")));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = function Footer() {
	    return _react2.default.createElement("footer", { className: "footer-main" }, "Kevin Watke. ©2016");
	};
