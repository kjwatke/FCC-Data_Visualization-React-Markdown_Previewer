	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement("div", { className: "app-container" }, _react2.default.createElement(_Heading2.default, null), _react2.default.createElement("textarea", { placeholder: "place md here", type: "text", className: "md-input", onChange: this.update, rows: 25 }), _react2.default.createElement("div", { className: "md-output", dangerouslySetInnerHTML: this.getMarkdownText(this.state.txt) }), _react2.default.createElement(_Footer2.default, null));
	        }
	    }]);
